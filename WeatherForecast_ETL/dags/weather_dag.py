...
def transform_load_data(task_instance):
    ...
    temp_farenheit = kelvin_to_fahrenheit(data['main'['feels_like']])
    min_temp_farenheit = kelvin_to_fahrenheit(data['main']['temp_min'])
    max_temp_farenheit = kelvin_to_fahrenheit(data['main']['temp_max'])
    pressure = data['main']['pressure']
    humidity = data['main']['humidity']
    wind_speed = data["wind"]["speed"]
    time_of_record = datetime.datetime(data['dt'] + data['timezone'])
    sunrise_time = datetime.datetime(data['sys']['sunrise'] + data['timezone'])
    sunset_time = datetime.datetime(data['sys']['sunset'] + data['timezone'])
    ...
    now = datetime.now()
    df_datetime = pd.DataFrame(transformed_data_list)
